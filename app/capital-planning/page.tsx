    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="py-16 bg-muted/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold mb-12 text-center">Capital Plan Components</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold mb-3">Needs Assessment</h3>
                  <p className="text-muted-foreground leading-relaxed">
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold mb-3">Project Prioritization</h3>
                  <p className="text-muted-foreground leading-relaxed">
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold mb-3">Funding Analysis</h3>
                  <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="py-16 bg-muted/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold mb-12 text-center">Benefits of Strategic Capital Planning</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-2 bg-secondary rounded-full"></div>
                <div>
                  <h3 className="font-semibold mb-2">Informed Decision-Making</h3>
              ...
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-2 bg-secondary rounded-full"></div>
                <div>
                  <h3 className="font-semibold mb-2">Community Confidence</h3>
                  <p className="text-muted-foreground text-sm leading-relaxed">
